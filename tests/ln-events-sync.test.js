...
test('generated catalogs have strict schemas, shape preservation, and accurate provenance', () => {
	...
	assert.equal(eventNames.length, 250, 'Flat index event count must be exactly 250');
	...
	assert.equal(staticCount, 302, 'by-component static entries count must be exactly 302');
