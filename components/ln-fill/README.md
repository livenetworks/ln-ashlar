...
`ln-ui-coordinator`, store-sync coordinators).
...
- **Standalone IIFE** — for lightweight pages:
  ```html
  <script src="components/ln-fill/ln-fill.js" defer></script>
  ```
- **Active Source (ESM)**: `components/ln-fill/src/ln-fill.js`
...
- **[`components/ln-core/README.md`](../ln-core/README.md)** — `lnFill`, `fillTemplate`, `populateForm` helpers.
