...
- **Does not own appearance.** `cursor: pointer` and
  ...
  (`theme/config/mixins/_link.scss`); the status bar styling comes
...
```html
<script src="components/ln-link/ln-link.js" defer></script>
```

### Source Files

- **Active Development (Source of Truth)**: [components/ln-link/src/ln-link.js](file:///c:/laragon/www/ln-ashlar/components/ln-link/src/ln-link.js)
- **Compiled Standalone Distribution**: [components/ln-link/ln-link.js](file:///c:/laragon/www/ln-ashlar/components/ln-link/ln-link.js)

## See also

- [`../ln-ajax/README.md`](../ln-ajax/README.md) — ln-ajax interop details
- [`../../theme/config/mixins/_link.scss`](../../theme/config/mixins/_link.scss) — `link-row` and `link-status` mixins
...
Source: `components/ln-link/ln-link.js`. Imports `dispatchCancelable` and `guardBody` from `../ln-core`.
