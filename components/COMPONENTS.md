...
If a component needs CSS, create `components/ln-{name}/ln-{name}.scss`:
...
(function () {
    ...
    function _init() {
        ...
        // <form data-ln-form data-ln-data-coordinator-scope="profiles" method="post" action="/api/profiles">
