...
| `data-ln-table-window` | Коренски контејнер | Број | - | Овозможува серверско скролање со лизгачки прозорец (sliding window virtualization) и евикција за големи сетови податоци. |
