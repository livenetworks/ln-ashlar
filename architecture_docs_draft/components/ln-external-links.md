...
*   **`ln-link`**: Овозможува примена на кликабилност на цели блокови. Доколку блокот содржи надворешен линк, `ln-external-links` дополнително ќе го заштити и санира соодветно.
