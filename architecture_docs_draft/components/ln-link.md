...
> **Изворен код:** [ln-link.js](../../js/ln-link/src/ln-link.js)
...
*   **[ln-table](./ln-table.md)**: Редовите во табелата често се опремуваат со `data-ln-link` за лесна навигација кон детален преглед на записите.
*   **[ln-external-links](./ln-external-links.md)**: Може да се користи заедно за одредување дали линковите во менијата треба автоматски да се однесуваат како надворешни.
