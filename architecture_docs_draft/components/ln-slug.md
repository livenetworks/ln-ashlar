...
*   **`ln-form`**: Формата во која се наоѓаат полињата.
*   **`ln-validate`**: Го слуша емитуваниот `input` настан од slug инпутот за да изврши проверка за валидност и уникатност на генерираната патека.
