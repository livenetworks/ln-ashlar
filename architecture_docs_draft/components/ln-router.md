...
> **Изворен код:** [ln-router.js](../../js/ln-router/src/ln-router.js)
...
Транзициите се олестени со автоматската интеграција на View Transitions API. CSS Engine-от може да ја дефинира формата на анимација:
...
*   **[ln-modal](./ln-modal.md)**: Нејзиниот систем за отворање преку хаш работи во кохезија со рутерот без меѓусебни конфликти.
*   **[ln-popover](./ln-popover.md)**: Нејзините отворени телепортирани инстанци во `body` се автоматски зачистени при деструкција на содржината на рутата.
