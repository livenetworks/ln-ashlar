...
`ln-nav` автоматски го override-ува `history.pushState` за да детектира URL промени од ln-ajax. Не е потребна додатна конфигурација — активниот линк се ажурира по секој AJAX навигација.
