...
The JavaScript source is located at [persist.js](../../js/ln-core/persist.js).
...
- **`{component}`:** Component identifier (e.g., `"filter"`, `"table-sort"`, `"toggle"`, `"tabs"`).
