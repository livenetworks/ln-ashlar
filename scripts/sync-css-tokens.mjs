...
export function generateThemingTable(sources) {
	...
	const rows = [
		...
		row('--bg-base', 'token', `${requireVar(lightVars, '--bg-base', '_palette.scss (ln-values-light)')} (light) / ${requireVar(darkVars, '--bg-base', '_palette.scss (ln-values-dark)')} (dark)`, 'Base canvas background'),
		row('--bg-elevated', 'token', `${requireVar(lightVars, '--bg-elevated', '_palette.scss (ln-values-light)')} (light) / ${requireVar(darkVars, '--bg-elevated', '_palette.scss (ln-values-dark)')} (dark)`, 'Elevated card surface (flat in light, +4% in dark)'),
		row('--bg-sunken', 'token', `${requireVar(lightVars, '--bg-sunken', '_palette.scss (ln-values-light)')} (light) / ${requireVar(darkVars, '--bg-sunken', '_palette.scss (ln-values-dark)')} (dark)`, 'Sunken well surface (darker in light, +7% in dark)'),
